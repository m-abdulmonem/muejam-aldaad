    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#success-alert').click(function () {
            ...
            swal({
                ...
                text: "برجاء الانتقال الى الملف الشخصى لإكمال اضافة بيانتك ويمكنك تركه!",
                type: "success",
                confirmButtonClass: 'btn-white btn-md waves-effect',
                confirmButtonClass: 'btn-success btn-md waves-effect waves-light',
                confirmButtonText: 'الانتقال الى الملف الشخصى؟'
            });
        });
